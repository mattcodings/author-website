...
//            static::$instance = new static();
    ...
    public function reviewShortCode($attributes){
        $output = '<h4 class="shortcode-header">A Review on Martin\'s Work</h4>';
