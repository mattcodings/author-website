...
class Subscribe_form_pro_review_box
{
	 ...
	 * @access public
	 */
	public $pluginName = "Subscribe Forms";
	 ...
	 * @access public
	 */
	public $pluginSlug = "subscribe-forms";
	 ...
	 * @access public
	 */
	public $wpPluginSlug = "wp-subscribe-form";
...
//	    $this->reviewStatus = true;
	...
	public function enqueue_scripts() {
		if (current_user_can('manage_options')) {
			wp_enqueue_style($this->pluginSlug."-star-rating-svg", plugins_url('includes/css/star-rating-svg.css', __FILE__), [], P_SUBSCRIBE_PLUGIN_VERSION);
			wp_enqueue_script($this->pluginSlug."-star-rating-svg", plugins_url('includes/js/jquery.star-rating-svg.min.js', __FILE__), ['jquery'], P_SUBSCRIBE_PLUGIN_VERSION);
		}
	}
	...
	public function admin_notices()
	{
        ...
        <div class="notice notice-info premio-notice <?php echo esc_attr($this->pluginSlug) ?>-premio-review-box">
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default">
                ...
                <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__co-founder">
                    ...
                    <img class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__co-founder-img" width="30" height="30" src="<?php echo esc_url(P_SUBSCRIBE_URL."images/premio-owner.png") ?>" />
                </div>
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you">
                <div class="thanks-wrap">
                    ...
                    <img class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you__image" width="200" src="<?php echo esc_url(P_SUBSCRIBE_URL."images/thanks.gif") ?>" />
        ...
        <script>
            (function($) {
                function SubscribeFormsProReview() {
                ...
                SubscribeFormsProReview.prototype.getSelectors = function() {
                    return {
                        body: 'body',
                ...
                SubscribeFormsProReview.prototype.getElements = function() {
                ...
                SubscribeFormsProReview.prototype.bindEvents = function() {
                ...
                SubscribeFormsProReview.prototype.feedbackFormHandler = function(ev) {
                    ev.preventDefault();
                    const elements  = this.getElements();
                ...
                SubscribeFormsProReview.prototype.thankYouDismissHandler = function() {
                    const elements = this.getElements();
                    elements.$reviewBox.remove();
                    elements.$reminderPopup.remove();
                    this.sendHideRequest( -1 );
                ...
                SubscribeFormsProReview.prototype.reminderHandler = function(ev) {
                    ev.preventDefault();
                ...
                SubscribeFormsProReview.prototype.sendHideRequest = function( dataDays = -1 ) {
                    $.ajax({
                        url: "<?php echo admin_url("admin-ajax.php") ?>",
                ...
                SubscribeFormsProReview.prototype.toggleReminderPopup = function( action = true ) {
                    if( action ) {
                ...
                SubscribeFormsProReview.prototype.feedbackToggle = function( action = true ) {
                    const elements = this.getElements();
                    console.log(action);
                    if( action ) {
                ...
                SubscribeFormsProReview.prototype.renderRating = function() {
                    const self      = this;
...
$Subscribe_form_pro_review_box = new Subscribe_form_pro_review_box();
