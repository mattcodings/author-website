<?php
class Subscribe_form_affiliate_program {

    public $plugin_name = "Subscribe Forms";

    public $plugin_slug = "subscribe-forms";
    ...
    public function admin_notices() {
        ...
        <div class="notice notice-info <?php echo esc_attr($this->plugin_slug) ?>-premio-affiliate <?php echo esc_attr($this->plugin_slug) ?>-premio-affiliate">
            ...
            <a class="button button-primary <?php echo esc_attr($this->plugin_slug) ?>-affiliate-btn" target="_blank" href="https://premio.io/affiliates/?utm_source=inapp&plugin=wp-subscribe-form&domain=<?php echo esc_attr($_SERVER['HTTP_HOST']) ?>">Tell me more <span class="dashicons dashicons-arrow-right-alt"></span></a>
        </div>
...
$Subscribe_form_affiliate_program = new Subscribe_form_affiliate_program();